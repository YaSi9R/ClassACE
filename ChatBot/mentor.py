...
# Load the dataset
with open('data/mentor.json', 'r') as file:
    data = json.load(file)
...
# Extracting data from mentor
X = []
y = []
for intent in data['mentor']:
...
def get_response(mentor, tag):
    for intent in mentor:
        if intent['tag'] == tag:
...
def chatbot_response(user_input):
    ...
    return get_response(data['mentor'], predicted_tag)
